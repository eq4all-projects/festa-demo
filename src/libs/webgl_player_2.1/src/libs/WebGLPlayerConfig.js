class WebGLPlayerConfig {
    constructor(system) {
        ...
        if (system === "AzureService") {
            ...
            this.fileOrigin = "https://service-az.eq4all.co.kr:8003/service-api/";
            this.APIOrigin = "https://service-az.eq4all.co.kr:8003/";
    ...
    getSentenceAPI(id) {
        ...
        } else if (this.system === "AzureService") {
            return "service-api/sendtoplayerregardlessofclscode/";
        }
    }
    ...
    getPartFileAPI(character, part) {
        if (this.system === "AzureService") {
            ...
            if (part.search(".FBX") > -1) return "characters/" + character + "/" + part;
    ...
    healthCheckAPI() {
        if (this.system === "AzureService") {
            return {
                ...
                data: { type: 13, search: "Eve", by: 23, method: 1, input_change_flag: 1 },
            };
        } else return null;
    }
